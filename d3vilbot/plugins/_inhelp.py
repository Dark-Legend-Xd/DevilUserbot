...
USER_BOT_WARN_ZERO = "𝖸𝗈𝗎 𝗐𝖾𝗋𝖾 𝗌𝗉𝖺𝗆𝗆𝗂𝗇𝗀 𝗆𝗒 𝗌𝗐𝖾𝖾𝗍 𝗆𝖺𝗌𝗍𝖾𝗋'𝗌 𝗂𝗇𝖻𝗈𝗑, 𝗁𝖾𝗇𝖼𝖾𝖿𝗈𝗋𝗍𝗁 𝗒𝗈𝗎 𝗁𝖺𝗏𝖾 𝖻𝖾𝖾𝗇 𝖻𝗅𝗈𝖼𝗄𝖾𝖽 𝖻𝗒 𝗆𝗒 𝗆𝖺𝗌𝗍𝖾𝗋'𝗌 𝖣e𝗏𝗂𝗅𝖡𝗈𝗍.**\n__𝖭𝗈𝗐 𝖦𝖳𝖥𝖮, 𝗂'𝗆 𝖻𝗎𝗌𝗒**"

D3VIL_FIRST = (
    "**Hello, 𝖳𝗁𝗂𝗌 𝗂𝗌 ∂єνιℓвσт 𝖴𝗅𝗍𝗋𝖺 𝖯𝗋𝗂𝗏𝖺𝗍𝖾 𝖲𝖾𝖼𝗎𝗋𝗂𝗍𝗒 𝖯𝗋𝗈𝗍𝗈𝖼𝗈𝗅⚠️ **\n 𝖳𝗁𝗂𝗌 𝗂𝗌 𝗍𝗈 𝗂𝗇𝖿𝗈𝗋𝗆 𝗒𝗈𝗎 𝗍𝗁𝖺𝗍 "
...
if Config.BOT_USERNAME is not None and tgbot is not None:
    ...
    async def on_pm_click(event):
        if event.query.user_id == bot.uid:
            ...
            await event.edit(
                f" 𝖳𝗁𝗂𝗌 𝗂𝗌 ∂єνιℓвσт 𝖯𝗆 𝖲𝖾𝖼𝗎𝗋𝗂𝗍𝗒 𝖿𝗈𝗋 {d3vil_mention} 𝗍𝗈 𝗄𝖾𝖾𝗉 𝖺𝗐𝖺𝗒 𝗎𝗇𝗐𝖺𝗇𝗍𝖾𝖽 𝗋𝖾𝗍𝖺𝗋𝖽𝗌 𝖿𝗋𝗈𝗆 𝗌𝗉𝖺𝗆𝗆𝗂𝗇𝗀 𝖯𝖬..."
            )
    ...
    async def reopn(event):
            if event.query.user_id == bot.uid or event.query.user_id in Config.SUDO_USERS:
                ...
                reply_pop_up_alert = "𝖧𝗈𝗈 𝗀𝗒𝖺 𝖺𝗉𝗄𝖺. 𝖪𝖺𝖻𝗌𝖾 𝗍𝖺𝗉𝖺𝗋 𝗍𝖺𝗉𝖺𝗋 𝖽𝖺𝖻𝖺𝖾 𝗃𝖺𝖺 𝗋𝗁𝖾 𝗁. 𝗄𝗁𝗎𝖽𝗄𝖺 𝖻𝗇𝖺 𝗅𝗈 𝗇𝖺 𝖺𝗀𝗋 𝖼𝗁𝗂𝗒𝖾 𝗍𝗂. © ∂єνιℓвσт™"
                await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid or event.query.user_id in Config.SUDO_USERS:
            ...
            await event.edit(f"**⚜️ ∂єνιℓвσт 𝖬êñû 𝖯𝗋õ𝗏î𝖽ê𝗋 ì𝗌 ñô𝗐 Ç𝗅ö𝗌ë𝖽 ⚜️**\n\n**𝖬𝖺𝗌𝗍𝖾𝗋 :**  {d3vil_mention}\n\n        [©️ ∂єνιℓвσт™️]({chnl_link})", buttons=veriler, link_preview=False)
        else:
            reply_pop_up_alert = "𝖧𝖾𝗅𝗅𝗈 𝗍𝗁𝖾𝗋𝖾 𝖣𝖾𝗉𝗅𝗈𝗒 𝗒𝗈𝗎𝗋 𝗈𝗐𝗇 𝖣E𝖵𝖨𝖫𝖡𝖮𝖳 𝖺𝗇𝖽 𝗎𝗌𝖾. © ∂єνιℓвσт™"
            await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
    ...
    async def page(event):
        ...
        if event.query.user_id == bot.uid or event.query.user_id in Config.SUDO_USERS:
            ...
            return await event.answer(
                "𝖧𝖾𝗅𝗅𝗈 𝗍𝗁𝖾𝗋𝖾 𝖣𝖾𝗉𝗅𝗈𝗒 𝗒𝗈𝗎𝗋 𝗈𝗐𝗇 𝖣E𝖵𝖨𝖫𝖡𝖮𝖳 𝖺𝗇𝖽 𝗎𝗌𝖾. © ∂єνιℓвσт™",
                cache_time=0,
                alert=True,
            )
