...
pm_caption += f"╠•➳➠ `¢нαииєℓ:` [𝙹𝗈𝗂𝗇](https://t.me/Devil_Us3rBot)\n"
pm_caption += f"╠•➳➠ `ѕυρρσят:` [∂єνιℓвσт ¢нαт](https://t.me/DevilB0T_CHAT)\n"
pm_caption += f"╠•➳➠ `¢яєαтσя:` [¢яєαтσя](https://t.me/mr_developer_xd)\n"
pm_caption += f"╚══════════════════╝\n"
